...
NUM_DATABASES = 10  # Number of database instances
MAX_DB_CAPACITY = 200  # Max images per database instance
SPLIT_THRESHOLD = 100  # If cluster has more than this, apply recursive 2-Means
